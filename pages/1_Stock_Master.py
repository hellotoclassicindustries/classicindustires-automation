...
try:
    ...
    if ledger_records:
        ...
        # 7. Build the Round Graph (Altair Layered Donut Chart with Outlined Text)
        ...
        # FIXED: Placed inside the ring with a solid white fill and high-visibility black outline
