...
# Define Your Multi-Page Layout Structure (POINTS ONLY TO STOCK_MASTER)
...
with st.sidebar:
    ...
    if st.session_state.authenticated:
        ...
        with st.form("Internal Personnel Authentication Log"):
            ...
            # FIX 1: Cleaned up duplicate variable assignment syntax error
            submit_login = st.form_submit_button("Unlock Secure Sheets")
            
            if submit_login:
                # FIX 2: Links directly to your centralized cloud deployment environment configuration keys
